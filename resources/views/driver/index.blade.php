                        ...
                        <tbody>
                            @foreach ($driver as $row)
                                <tr>
                                    ...
                                    <td>{{$row->ciudad}}</td>
                                    <td>
                                        <a href="{{url('/driver/'.$row->id.'/edit')}}" rel="tooltip" title="Editar" class="btn btn-link btn-simple btn-xs">
                                            <i class="fas fa-user-edit iconos_oc"></i> 
                                        </a>

                                        <a href="{{url('/driver/'.$row->id.'/delete')}}" rel="tooltip" title="Eliminar" class="btn btn-link btn-simple btn-xs" onclick="return confirm('¿Está seguro de que desea eliminar este registro?')">
